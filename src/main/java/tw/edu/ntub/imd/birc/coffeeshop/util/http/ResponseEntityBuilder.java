...
import tw.edu.ntub.imd.birc.coffeeshop.util.function.TripleConsumer;
import tw.edu.ntub.imd.birc.coffeeshop.util.json.ResponseData;
import tw.edu.ntub.imd.birc.coffeeshop.util.json.array.ArrayData;
import tw.edu.ntub.imd.birc.coffeeshop.util.json.array.CollectionArrayData;
import tw.edu.ntub.imd.birc.coffeeshop.util.json.array.MapArrayData;
import tw.edu.ntub.imd.birc.coffeeshop.util.json.object.ObjectData;
import tw.edu.ntub.imd.birc.coffeeshop.dto.CodeEntry;
import tw.edu.ntub.imd.birc.coffeeshop.util.function.AddObjectDataConsumer;
import tw.edu.ntub.imd.birc.coffeeshop.util.function.AddObjectDataMapConsumer;
